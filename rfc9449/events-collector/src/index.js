...
// no proprio log do container (`podman logs -f oauth9449-events`) — sem UI,
...
app.listen(PORT, () => {
  console.log(DIVIDER);
  console.log('  observador de eventos HTTP -- RFC 9449 lab (DPoP + Discovery + Dynamic Registration)');

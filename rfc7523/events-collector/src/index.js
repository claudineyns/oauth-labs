...
// no proprio log do container (`podman logs -f oauth7523-events`) — sem UI,
...
app.listen(PORT, () => {
  console.log(DIVIDER);
  console.log('  observador de eventos HTTP -- RFC 7523 lab (private_key_jwt + Discovery + Dynamic Registration)');
